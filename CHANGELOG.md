...
### Changed
- `ASFProduct`s are now aware of the session used during search and will use that by default to download. A session can still be explicitly provided as before.
