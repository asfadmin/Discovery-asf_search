...
L1A_RADAR_RO = "SMAP_L1A_RO_V3",
L1A_RADAR = "SMAP_L1A_V2",
L1B_S0_LORES = "SMAP_L1B_S0_V3",
L1C_S0_HIRES = "SMAP_L1C_S0_V3",
...
AMPLITUDE = "AMPLITUDE"
"""[Deprecated] UAVSAR product file types are now consolidated under `POLSAR` and `RPI`"""
STOKES = "STOKES"
"""[Deprecated] UAVSAR product file types are now consolidated under `POLSAR` and `RPI`"""
