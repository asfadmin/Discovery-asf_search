...
dataset_collections = {
    ...
    'SENTINEL-1': {
        ...
        'SENTINEL-1D_OCN': ['C1281540904-ASF', 'C4162942865-ASF'],
        'SENTINEL-1D_DP_GRD_HIGH': ['C1281540913-ASF', 'C4163054563-ASF'],
        'SENTINEL-1D_DP_GRD_MEDIUM': ['C1281644436-ASF', 'C4174076966-ASF'],
        'SENTINEL-1D_SLC': ['C1281496163-ASF', 'C4175278193-ASF'],
        'SENTINEL-1D_SP_GRD_HIGH': ['C1281643926-ASF', 'C4174044457-ASF'],
        'SENTINEL-1D_SP_GRD_MEDIUM': ['C1281657114-ASF', 'C4175200051-ASF'],
        'SENTINEL-1D_RAW': ['C1281496248-ASF', 'C4175250274-ASF'],
        'SENTINEL-1D_DP_META_GRD_HIGH': ['C1281643927-ASF', 'C4171102786-ASF'],
        'SENTINEL-1D_DP_META_GRD_MEDIUM': ['C1281657235-ASF', 'C4174076945-ASF'],
        'SENTINEL-1D_META_OCN': ['C1281540906-ASF', 'C4162996551-ASF'],
        'SENTINEL-1D_META_RAW': ['C1281496301-ASF', 'C4175250286-ASF'],
        'SENTINEL-1D_META_SLC': ['C1281496226-ASF', 'C4175278190-ASF'],
        'SENTINEL-1D_SP_META_GRD_HIGH': ['C1281563948-ASF', 'C4174044493-ASF'],
        'SENTINEL-1D_SP_META_GRD_MEDIUM': ['C1281644435-ASF', 'C4175200042-ASF'],
        'SENTINEL-1C_SLC': [
            'C3470873558-ASF',
            'C1273088271-ASF',
        ],
    ...
    'UAVSAR': {
        'UAVSAR_POLSAR': ['C1276999406-ASFDEV', 'C1280526704-ASF'],
        'UAVSAR_RPI': [
            'C1277000981-ASFDEV',
            'C1281202659-ASF',
        ],
...
collections_by_processing_level = {
    ...
    'L0B': [
        ...
        'C1273831320-ASF',
        'C3622228339-ASF',
        'C1273126538-ASFDEV',  # Provisional
        'C1273445045-ASF',
        'C2853089814-ASF',
        'C1273126543-ASFDEV',  # Validated
        'C1273445159-ASF',
        'C3622265756-ASF',
        'C1258125097-ASFDEV',
        'C1258836794-ASF',
    ...
    'RSLC': [
        ...
        'C1273831203-ASF',
        'C2850225585-ASF',
        'C1273095152-ASFDEV',  # Provisional
        'C1273153208-ASF',
        'C2853145197-ASF',
    ...
    'RIFG': [
        ...
        'C1273831200-ASF',
        'C2850234202-ASF',
        'C1273095181-ASFDEV',  # Provisional
        'C1273153326-ASF',
        'C2853147928-ASF',
        'C1273095184-ASFDEV',  # Validated
        'C1273287787-ASF',
        'C3622229381-ASF',
    ],
    'RUNW': [
        ...
        'C1261819121-ASF',
        'C2850235455-ASF',
        'C1273152981-ASFDEV',  # Provisional
        'C1273220358-ASF',
        'C2853153429-ASF',
        'C1273152983-ASFDEV',  # Validated
        'C1273220386-ASF',
        'C3622237369-ASF',
    ],
    'ROFF': [
        ...
        'C1261819145-ASF',
        'C2850237619-ASF',
        'C1273153081-ASFDEV',  # Provisional
        'C1273316385-ASF',
        'C2853156054-ASF',
        'C1273153083-ASFDEV',  # Validated
        'C1273316399-ASF',
        'C3622241997-ASF',
    ],
    'GCOV': [
        ...
        'C1273831195-ASF',
        'C3622214170-ASF',
        'C1273304517-ASFDEV',  # Provisional
        'C1273428591-ASF',
        'C2854338529-ASF',
        'C1273304519-ASFDEV',  # Validated
        'C1273428593-ASF',
        'C3622241360-ASF',
    ],
    'GOFF': [
        ...
        'C1261819281-ASF',
        'C2850263910-ASF',
        'C1273304466-ASFDEV',  # Provisional
        'C1273429896-ASF',
        'C2854341702-ASF',
        'C1273304468-ASFDEV',  # Validated
        'C1273429898-ASF',
        'C3622250865-ASF',
    ],
    'GSLC': [
    ...
    'SME2': [
        'C1273421239-ASFDEV',  # Beta
        'C1273553457-ASF',
        'C2850265000-ASF',
        'C1273410799-ASFDEV',  # Provisional
        'C1273602244-ASF',
        'C2854344945-ASF',
        'C1273410801-ASFDEV',  # Validated
        'C1273602265-ASF',
        'C3622248530-ASF',
    ],
    # UAVSAR
    'POLSAR': ['C1276999406-ASFDEV', 'C1280526704-ASF'],
    'RPI': [
        'C1277000981-ASFDEV',
        'C1281202659-ASF',
    ],
